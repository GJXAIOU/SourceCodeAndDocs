...
Spring makes it easy to create Java enterprise applications. It provides everything you need to embrace （包括）the Java language in an enterprise environment, with support for Groovy and Kotlin as alternative（可替代的） languages on the JVM, and with the flexibility to create many kinds of architectures depending on an application’s needs. As of Spring Framework 5.1, Spring requires JDK 8+ (Java SE 8+) and provides out-of-the-box support for JDK 11 LTS. Java SE 8 update 60 is suggested as the minimum patch release for Java 8, but it is generally recommended to use a recent patch release.

Spring 使得我们更易于开发企业级应用，它在具有可替代性的、运行在 JVM 的 Groovy 和 Kotlin 语言的支持下提供了在商业环境中 Java 语言需要包含的所有东西，同时可以根据应用需求来创建各种架构依赖。 Spring 5.1 框架需要 JDK 版本在 8 及其以上，同时针对 JDK 11 LTS 提供了即开即用的支持，JDK8，Update 60(JDK 8u60) 版本作为 JDK8 最小的发布版本，但是推荐使用 JDK8 较新的版本。
